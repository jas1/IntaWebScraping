#' almacenar_datos_ganaderia_valores_actuales_func
...
#' @export
#'
#' @examples almacenar_datos_ganaderia_valores_actuales_func(transformacion_df,config)
almacenar_datos_ganaderia_valores_actuales_func <- function(transformacion_df,config){
  ...
  if (nrow(transformacion_df)>0) {
    ...
    print(glue::glue("almacenar_datos_ganaderia_valores_actuales_func: no hay datos de ganaderia") )

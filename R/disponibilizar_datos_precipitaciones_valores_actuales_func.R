#' disponibilizar_datos_precipitaciones_valores_actuales_func
...
#' @export
#'
#' @examples disponibilizar_datos_precipitaciones_valores_actuales_func(path_almacenado,config)
disponibilizar_datos_precipitaciones_valores_actuales_func <- function(path_almacenado,config){
  ...
  if (path_almacenado!='') {
    ...
    warning("disponibilizar_datos_precipitaciones_valores_actuales_func: sin datos.")
  }
  ret
}

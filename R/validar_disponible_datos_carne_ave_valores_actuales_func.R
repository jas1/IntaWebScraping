#' validar_disponible_datos_carne_ave_valores_actuales_func
#'
...
#' @export
#'
#' @examples validar_disponible_datos_carne_ave_valores_actuales_func(almacenar_datos_valores, disponibilizar_datos_resultado,config)
validar_disponible_datos_carne_ave_valores_actuales_func <- function(almacenar_datos_valores, disponibilizar_datos_resultado,config){
  ...
  if (almacenar_datos_valores != '') {
    ...
    warning("validar_disponible_datos_carne_ave_valores_actuales_func: para actualziar carne_ave")
  }
  ret
}

#' validar_disponible_datos_ganaderia_valores_actuales_func
#'
...
#' @export
#'
#' @examples validar_disponible_datos_ganaderia_valores_actuales_func(almacenar_datos_valores, disponibilizar_datos_resultado,config)
validar_disponible_datos_ganaderia_valores_actuales_func <- function(almacenar_datos_valores, disponibilizar_datos_ganaderia_valores_actuales,config){
  ...
  if (almacenar_datos_valores != '') {
    ...
    resultado_sheet <- googlesheets4::read_sheet(ss = disponibilizar_datos_ganaderia_valores_actuales[['url']],
                                                 sheet = disponibilizar_datos_ganaderia_valores_actuales[['sheet']])
    ...
    warning("validar_disponible_datos_ganaderia_valores_actuales_func: para actualziar ganaderia")
  }
  ret
}

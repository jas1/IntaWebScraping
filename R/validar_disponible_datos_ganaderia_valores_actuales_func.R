validar_disponible_datos_ganaderia_valores_actuales_func <- function(almacenar_datos_ganaderia_valores_actuales, disponibilizar_datos_ganaderia_valores_actuales,config){

  # verificar que lo almacenado es igual a lo disponible.
  resultado_file_almacenar <- readr::read_tsv(almacenar_datos_ganaderia_valores_actuales)

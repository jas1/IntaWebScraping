...
:: referencia windows: https://stackoverflow.com/questions/1192476/format-date-and-time-in-a-windows-batch-script
...
cd %current_path%
"C:/Program Files/R/R-4.2.3/bin/Rscript" "%current_path%/tar_exec.R" >>"%LOG_FILE%"
...
testthat::test_that("validar_configuracion",{
  ...
  testthat::expect_true(leer_configuracion_scrap[["scrap_recursos_ave_url"]] ==config_valida[["scrap_recursos_ave_url"]])

})

# 02 - obtener_datos_recursos_huevo -------------------------------------------------
# obtener_datos_recursos_huevo <- get_datos_recursos_ave_huevos_func(leer_configuracion_scrap)
testthat::test_that("get_datos_recursos_ave_huevos_func",{
  #Sys.setenv(R_CONFIG_ACTIVE = "default")
  source(here::here("R","leer_configuracion.R"))
...
testthat::test_that("procesar_datos_huevo_valores_actuales",{
  #Sys.setenv(R_CONFIG_ACTIVE = "default")
  source(here::here("R","leer_configuracion.R"))
  source(here::here("R","get_datos_recursos_ave_huevos_func.R"))
  source(here::here("R","get_raw_web_file.R"))
  ...
  cols_expected <- c('descripcion','precio','fecha_semana')

  testthat::expect_equal(cols_df,expected = cols_expected)
  testthat::expect_true(all(stringr::str_detect(procesar_datos[["descripcion"]],"semanas blanca")))
...
# 05 - transformar_datos_huevo_valores_actuales -------------------------------------------------
# transformar_datos_huevo_valores_actuales <- transformar_datos_carne_ave_valores_actuales_func(procesar_datos_huevo_valores_actuales)
testthat::test_that("transformar_datos_huevo_valores_actuales",{
  #Sys.setenv(R_CONFIG_ACTIVE = "default")
  source(here::here("R","leer_configuracion.R"))
  source(here::here("R","get_datos_recursos_ave_huevos_func.R"))
  source(here::here("R","get_raw_web_file.R"))
  ...
  # ----------------------------
  raw_datos <- get_datos_recursos_ave_huevos_func(leer_configuracion_scrap)
  ...
  transform_datos <- transformar_datos_carne_ave_valores_actuales_func(porcesados_datos)
  ...
  testthat::expect_equal(cols_df,expected = cols_expected)
  testthat::expect_true(all(stringr::str_detect(transform_datos[["indices_tabla"]],"olla recriada")))
})


# lo almaceno como huevo o con recurso ? si recurso agregarle valores viejos:
# 06 - almacenar_datos_carne_ave_valores_actuales_func -------------------------------------------------
# almacenar_datos_huevo_valores_actuales <- almacenar_datos_carne_ave_valores_actuales_func(transformar_datos_huevo_valores_actuales)
testthat::test_that("almacenar_datos_carne_ave_valores_actuales_func",{
  #Sys.setenv(R_CONFIG_ACTIVE = "default")
  source(here::here("R","leer_configuracion.R"))
  source(here::here("R","get_datos_recursos_ave_huevos_func.R"))
  source(here::here("R","get_raw_web_file.R"))
  ...
  transform_datos <- transformar_datos_carne_ave_valores_actuales_func(porcesados_datos)
  # ----------------------------
  resultado_almacenar_path <- almacenar_datos_carne_ave_valores_actuales_func(transform_datos,leer_configuracion_scrap)
  ...
  testthat::expect_gt(cant_rows, expected = 0)
  testthat::expect_equal(cols_df,expected = cols_expected)
  testthat::expect_true(all(stringr::str_detect(resultado_file_almacenar[["indices_tabla"]],"olla recriada")))
})


# 07 - disponibilizar_datos_carne_ave_valores_actuales_func -------------------------------------------------
# disponibilizar_datos_huevo_valores_actuales <- disponibilizar_datos_carne_ave_valores_actuales_func(path_files,cfg)

testthat::test_that("disponibilizar_datos_carne_ave_valores_actuales_func",{
  #Sys.setenv(R_CONFIG_ACTIVE = "default")
  source(here::here("R","leer_configuracion.R"))
  source(here::here("R","get_datos_recursos_ave_huevos_func.R"))
  source(here::here("R","get_raw_web_file.R"))
  ...
  # ----------------------------
  resultado_disponibilizar <- disponibilizar_datos_carne_ave_valores_actuales_func(resultado_almacenar_path,leer_configuracion_scrap)


  testthat::expect_true(resultado_disponibilizar[["url"]]==leer_configuracion_scrap[["destino_recursos_url"]])
  testthat::expect_true(resultado_disponibilizar[["sheet"]]==leer_configuracion_scrap[["destino_carne_ave_sheet"]])
  # ----------------------------
...
# 08 - validar_disponible_datos_carne_ave_valores_actuales_func -------------------------------------------------
# validar_disponible_datos_huevo_valores_actuales <- validar_disponible_datos_carne_ave_valores_actuales_func(almacenar_datos_huevo_valores_actuales,disponibilizar_datos_huevo_valores_actuales)

testthat::test_that("validar_disponible_datos_carne_ave_valores_actuales_func",{
  ...
  # ----------------------------
  resultado_validar <- validar_disponible_datos_carne_ave_valores_actuales_func(resultado_almacenar_path,resultado_disponibilizar,leer_configuracion_scrap)
